 ...
 * @author libra
 */
public class ProviderInterServiceStub_7020 implements ProviderInterService{
	private final ProviderInterService service;
	/**
	 * 传入的是接口定义的远程代理对象
	 * @param service
	 */
	public ProviderInterServiceStub_7020(ProviderInterService service) {
		super();
	...
	@Override
	public List<?> getAll() {
		System.out.println( "ProviderInterServiceStub_7020【本地存根】.getAll()" );
		return service.getAll();
	}

	@Override
	public Table_data getOne(Integer id) {
		System.out.println( "ProviderInterServiceStub_7020【本地存根】.getOne()" );
		return service.getOne(id);
	}

	@Override
	public Map<String, List<Table_data>> delOne(Integer id) {
		System.out.println( "ProviderInterServiceStub_7020【本地存根】.delOne()" );
		return service.delOne(id);
	}

	@Override
	public Table_data insert(Table_data data) throws Exception {
		System.out.println( "ProviderInterServiceStub_7020【本地存根】.insert()" );
		return service.insert(data);
	}

	@Override
	public Map<String, Table_data> update(Table_data data) throws Exception {
		System.out.println( "ProviderInterServiceStub_7020【本地存根】.update()" );

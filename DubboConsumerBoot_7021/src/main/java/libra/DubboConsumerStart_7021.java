...
public class DubboConsumerStart_7021 {
	public static void main(String[] args) {
		try {
			System.out.println( "Dubbo.Springboot.Start" );
			ConfigurableApplicationContext cac = org.springframework.boot.SpringApplication.run(DubboConsumerStart_7021.class, args);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
